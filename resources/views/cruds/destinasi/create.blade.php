...
@section('pageTitle', 'SIREKAP - PASMI | Destinasi | Tambah')
@section('titleContent', 'Tambah Destinasi Baru')
    ...
    <div class="h-full overflow-y-auto py-4">
        <div class="mx-auto max-w-3xl space-y-6 px-2 font-inter">
            <div class="flex flex-col justify-between gap-4 md:flex-row md:items-start">
                <div class="space-y-1">
                    <h2 class="text-xl font-semibold text-zinc-800">Tambah Negara Tujuan</h2>
                    <p class="text-sm text-zinc-500">Lengkapi data negara tujuan penempatan untuk modul SIREKAP PASMI.</p>
                </div>
            ...
            <form action="{{ route('sirekap.destinasi.store') }}" method="POST"
                ...
                <div class="space-y-10 p-6 md:p-8">
                    <section class="space-y-6">
                        <div>
                            ...
                            <p class="text-sm text-zinc-500">Informasi utama negara tujuan.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <label class="block text-sm font-medium text-zinc-700">
                                ...
                                <input type="text" name="kode" value="{{ old('kode') }}" maxlength="3" required
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            <label class="block text-sm font-medium text-zinc-700">
                                Benua
                                <input type="text" name="benua" value="{{ old('benua') }}" maxlength="100"
