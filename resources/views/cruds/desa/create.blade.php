...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Tambah Desa/Kelurahan</h1>
            <p class="mt-1 text-sm text-zinc-600">Pilih kecamatan induk lalu masukkan nama desa/kelurahan yang valid.</p>
        </div>
        ...
        <form action="{{ route('sirekap.desa.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" maxlength="100" required
