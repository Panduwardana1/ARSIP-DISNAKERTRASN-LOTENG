...
@php
    /** @var \App\Models\TenagaKerja $tenagaKerja */
    ...
    /** @var array $genders */
    $formTitle = 'Ubah Data Tenaga Kerja';
@endphp
...
@section('content')
    <section class="container mx-auto space-y-6 px-4">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-zinc-600">
                    Sesuaikan data CPMI lalu simpan perubahan.
                </p>
            </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-6xl">
            <form action="{{ route('sirekap.tenaga-kerja.update', $tenagaKerja) }}" method="POST" class="space-y-2 border">
                @csrf
                @method('PUT')
