...
<div class="space-y-6">
    ...
    <div class="space-y-2">
        ...
        <input type="file" id="gambar" name="gambar" accept=".png,.jpg,.jpeg"
            class="w-full rounded-md border border-dashed border-zinc-300 bg-zinc-50 px-3 py-2 text-sm text-zinc-800 focus:outline-none focus:border-blue-300">
        <p class="text-xs text-zinc-500">
            Format yang diperbolehkan: PNG, JPG, atau JPEG (maks. 2 MB) - (Opsional).
        </p>
        @error('gambar')
    ...
    <div class="flex items-center justify-end gap-3 pt-2">
        ...
        <button type="submit"
            ...
            {{ isset($perusahaan) ? 'Update' : 'Simpan' }}
        </button>
    </div>
</div>
