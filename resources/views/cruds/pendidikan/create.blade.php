...
@section('titlePageContent', 'Tambah Data Pendidikan')
        ...
        <main class="flex-1 px-4 py-6">
            <div class="mx-auto max-w-3xl space-y-6">
                <div class="flex flex-col justify-between gap-4 md:flex-row md:items-start">
                    <div class="space-y-1">
                        <h2 class="text-xl font-semibold text-zinc-900">Formulir Pendidikan</h2>
                        <p class="text-sm text-zinc-500">
                            Lengkapi data pendidikan untuk digunakan pada modul tenaga kerja.
                        </p>
                    </div>
                    ...
                    <div class="space-y-8 p-6 md:p-10">
                        <section class="space-y-4">
                            <header>
                                ...
                                <p class="text-sm text-zinc-500">Pastikan nama dan level sesuai dengan standar pendidikan nasional.</p>
                            </header>
