...
@section('content')
    ...
    <div class="max-w-3xl mx-auto bg-white border border-zinc-200 shadow-sm rounded-lg p-6 space-y-6">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Tambah Data Negara</h1>
            <p class="text-sm text-zinc-600 mt-1">Lengkapi informasi negara baru kemudian simpan.</p>
        </div>

        <form action="{{ route('sirekap.negara.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
