...
@section('content')
    ...
    <div class="max-w-3xl mx-auto bg-white border border-zinc-200 shadow-sm rounded-lg p-6 space-y-6">
        ...
        <form action="{{ route('sirekap.negara.update', $negara) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input
                    ...
                    id="kode_iso"
                    name="kode_iso"
                    value="{{ old('kode_iso', $negara->kode_iso) }}"
                    maxlength="5"
                    required
