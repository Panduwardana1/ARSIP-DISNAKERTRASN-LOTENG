...
@section('titlePageContent', 'Detail Agensi')
...
@section('headerActions')
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('disnakertrans.agensi.edit', $agensi) }}"
    ...
    <div class="max-w-3xl mx-auto w-full px-4 py-6">
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-zinc-200">
            <div class="border-b border-zinc-200 pb-4">
                <h2 class="text-xl font-semibold text-zinc-800">{{ $agensi->nama_agensi }}</h2>
            </div>

            <dl class="mt-6 space-y-4">
                <div>
                    <dt class="text-sm font-semibold text-zinc-600">Lokasi</dt>
                    <dd class="mt-1 text-sm text-zinc-800">{{ $agensi->lokasi ?: '-' }}</dd>
                </div>
            </dl>
