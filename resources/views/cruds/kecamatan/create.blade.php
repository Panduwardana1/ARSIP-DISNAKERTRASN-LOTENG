...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-600">Isikan nama dan kode kecamatan sesuai referensi resmi.</p>
        </div>
        ...
        <form action="{{ route('sirekap.kecamatan.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode') }}" maxlength="10"
